...
const slides = [
  { id: 1, src: getImagePath('/images/slide1.png'), alt: '슬라이드 1' },
  { id: 2, src: getImagePath('/images/slide2.png'), alt: '슬라이드 2' },
  { id: 3, src: getImagePath('/images/slide3.png'), alt: '슬라이드 3' },
  { id: 4, src: getImagePath('/images/slide4.png'), alt: '슬라이드 4' },
  { id: 5, src: getImagePath('/images/slide5.png'), alt: '슬라이드 5' },
];
