              ...
              <div className="pf-panel">
                <div className="pf-panel-head">
                  ...
                  <div className="pf-seg">
                    ...
                    <button
                      type="button"
                      className={`pf-seg-btn ${resvFilter === "UPCOMING" ? "is-active" : ""}`}
                      onClick={() => setResvFilter("UPCOMING")}
                    >
                      진행중
                    </button>
                    <button
                      type="button"
                      className={`pf-seg-btn ${resvFilter === "COMPLETED" ? "is-active" : ""}`}
                      onClick={() => setResvFilter("COMPLETED")}
                    >
                      완료
                    </button>
                  </div>
                        ...
                        <div className="pf-item" key={it.bookingId}>
                          <div className="pf-item-main">
                            ...
                            <p className="pf-item-sub">
                              체험일: {dayjs(it.date).format("YYYY.MM.DD")} · 인원 {it.people}명 ·{" "}
                    ...
                    {bookmarks.map((b) => (
                      <div className="pf-item" key={b.programId}>
                        <div className="pf-item-main">
                          ...
                          <p className="pf-item-sub">
                            저장일: {b.savedAt ? dayjs(b.savedAt).format("YYYY.MM.DD") : "-"}
                          </p>
                          ...
                          <div className="pf-item-actions">
                            <button
                              type="button"
                              className="pf-linkbtn"
                              onClick={() => navigate(`/list/${b.programId}`)}
                            >
                              상세
                            </button>
