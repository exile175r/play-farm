          ...
          <div className="admin-detail-grid">
            ...
            <div className="admin-detail-row">
              ...
              <span className="admin-detail-value">
                {selectedReservation.date ? dayjs(selectedReservation.date).format('YYYY-MM-DD') : '-'} {selectedReservation.timeSlot || ''}
              </span>
            </div>
            <div className="admin-detail-row">
            ...
            <div className="admin-detail-row">
              ...
              <span className="admin-detail-value">
                {selectedReservation.createdAt ? dayjs(selectedReservation.createdAt).format('YYYY-MM-DD HH:mm') : '-'}
              </span>
            </div>
            <div className="admin-detail-row">
